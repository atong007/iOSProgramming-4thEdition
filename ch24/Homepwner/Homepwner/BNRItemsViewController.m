...
#pragma mark - UIDataSourceModelAssociation方法
- (NSString *)modelIdentifierForElementAtIndexPath:(NSIndexPath *)idx inView:(UIView *)view
{
    ...
    if (idx && view) {
        ...
        BNRItem *item = [[BNRItemStore sharedInstance] allItems][idx.row];
...
/**
 *  根据BNRItem对象的唯一标识符返回其所在的NSIndexPath
 */
- (NSIndexPath *)indexPathForElementWithModelIdentifier:(NSString *)identifier inView:(UIView *)view
{
    ...
    if (identifier && view) {
        NSArray *items = [[BNRItemStore sharedInstance] allItems];
