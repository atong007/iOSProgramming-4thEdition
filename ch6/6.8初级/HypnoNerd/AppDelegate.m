...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    BNRReminderViewController *reminderVC = [[BNRReminderViewController alloc] initWithNibName:NSStringFromClass([BNRReminderViewController class]) bundle:[NSBundle mainBundle]];
